...
namespace Flynt\Components\GridCustomContents;
...
{
    return [
        'name' => 'GridCustomContents',
        'label' => __('Grid: Custom Contents', 'flynt'),
        'sub_fields' => [
            [
...
// add_filter('Flynt/addComponentData?name=GridCustomContents', function (array $data): array {
